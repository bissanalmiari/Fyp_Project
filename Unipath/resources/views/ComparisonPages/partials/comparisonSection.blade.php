...
<div class="comparison-results mt-12">
        ...
        <table class="comparison-table">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(is_null($row['program_a_points']))
                                —
                            @else
                                <div class="score-pill">{{ $formatPoints($row['program_a_points']) }}</div>
                                <div class="score-percent">{{ $row['program_a_percent'] }}%</div>
                            @endif
                        </td>
                        ...
                        <td>
                            @if(is_null($row['program_b_points']))
                                —
                            @else
                                <div class="score-pill">{{ $formatPoints($row['program_b_points']) }}</div>
                                <div class="score-percent">{{ $row['program_b_percent'] }}%</div>
                            @endif
                        </td>
                ...
                <tr class="summary-row">
                    ...
                    <td>
                        @if($summaryRow)
                            <div class="score-pill">{{ $formatPoints($summaryRow['program_a_points']) }}</div>
                            <div class="score-percent">{{ $summaryRow['program_a_percent'] }}%</div>
                        @else
                            —
                        @endif
                    </td>
                    ...
                    <td>
                        @if($summaryRow)
                            <div class="score-pill">{{ $formatPoints($summaryRow['program_b_points']) }}</div>
                            <div class="score-percent">{{ $summaryRow['program_b_percent'] }}%</div>
                        @else
                            —
                        @endif
                    </td>
