        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-500 text-center md:text-left font-[Poppins]">
                    ...
                    <li><a href="{{ url('/universities') }}" class="hover:text-[#7F64CE] transition">Universities</a></li>
                    @auth
                        <li>
                            <a href="{{ url('student/personal') }}" class="hover:text-[#7F64CE] transition">
                                Profile
                            </a>
                        </li>
                    @endauth
                    ...
                    @guest
                        <li>
                            <a href="{{ route('login') }}" class="hover:text-[#7F64CE] transition">
                                Login
                            </a>
                        </li>
                    @endguest
